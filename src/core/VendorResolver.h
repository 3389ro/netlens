...
/// Resolves a MAC address to a vendor name using the embedded IEEE OUI
/// registry data (~52k entries across MA-L /24, MA-M /28 and MA-S /36
/// assignments — public IEEE records, no copyright claim, no attribution).
///
